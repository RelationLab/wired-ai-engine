"""
表结构的工具，v4之后将表结构的描述放到table_info.txt中，该文件废弃
"""
import csv
...
collection = Collection(name="table_info_new_v2")


def table_info_search_v2(text):
    search_params = {
        "metric_type": "L2"
    }
