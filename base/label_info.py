...
# 创建collection的表字段
question_schema = FieldSchema(name='label_name', dtype=DataType.VARCHAR, max_length=4096)
answer_schema = FieldSchema(name='label_desc', dtype=DataType.VARCHAR, max_length=8192)
...
collection = Collection(name="label_info", schema=schema, using='default', consistency_level="Session")
