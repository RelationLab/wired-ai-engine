...
def create_msg(tables, question, history):
    messages = [
        ...
        When you determine that there is a conflict between the results of the match and the explanation of the table, please refer to the explanation of the table.
        """),
